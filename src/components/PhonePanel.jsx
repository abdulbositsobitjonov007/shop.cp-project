  ...
  return (
    <div className='md:hidden px-5 py-1 border-t fixed bottom-0 bg-white w-full z-10 border-t-[#b2b2b2]'>
        <ul className='flex items-center justify-between'>
              ...
              <Link to={"cart"} className='relative flex flex-col text-center'><img className='w-7.5' src="/Frame.svg" alt="" />Cart <span className='absolute top-0.2 -right-1 bg-[red] border border-[black] text-white flex items-center justify-center rounded-[10px] h-3.75 w-3.75'>0</span></Link>
